...
public interface EnvI<T, ENV extends EnvI<T, ENV>> extends Serializable {
    ...
    /**
     * Return true if the given {@code name} is a free-variable. If {@code name} is
     * free, {@link #hasVariable(String)} must return true.
     *
     * @param name the variable name
    ...
    /**
     * Return true if the given {@code name} is a bound-variable. If {@code name} is
     * bound, {@link #hasVariable(String)} must return true and
     ...
     * @return this class
     * @throws IllegalArgumentException if the provided name is not a free variable
     *                                  for this transaction, or if the provided
     *                                  value is an not instance of the expected
     *                                  class of the free variable.
     */
    ...
    /**
     * Return an immutable collection of the free variables. For each name,
     * {@link #hasVariable(String)} and {@link #isFree(String)} must return true.
     *
    ...
    /**
     * Return an immutable collection of the free variables. For each name,
     * {@link #hasVariable(String)} and {@link #isBound(String)} must return true.
     *
