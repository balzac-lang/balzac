...
public class AbstractScriptBuilderTest {
    ...
    public void test_optimize() {
        Script s = new ScriptBuilder().op(OP_TOALTSTACK).op(OP_FROMALTSTACK).build();
    ...
    public void test_optimize2() {
        Script s = new ScriptBuilder().op(OP_TOALTSTACK).number(4).op(OP_FROMALTSTACK).build();
    ...
    public void test_optimize3() {
        Script s = new ScriptBuilder().op(OP_TOALTSTACK).op(OP_FROMALTSTACK).number(4).op(OP_TOALTSTACK)
            .op(OP_FROMALTSTACK).build();
        ...
        assertArrayEquals(s.getProgram(),
            new byte[] { OP_TOALTSTACK, OP_FROMALTSTACK, OP_4, OP_TOALTSTACK, OP_FROMALTSTACK });
    ...
    public void test_optimize5() {
        Script s = new ScriptBuilder().op(OP_TOALTSTACK).op(OP_TOALTSTACK).number(4).op(OP_FROMALTSTACK)
            .op(OP_FROMALTSTACK).build();
        ...
        assertArrayEquals(s.getProgram(),
            new byte[] { OP_TOALTSTACK, OP_TOALTSTACK, OP_4, OP_FROMALTSTACK, OP_FROMALTSTACK });
        assertArrayEquals(s.getProgram(), opt.getProgram());
    }

    @Test
    public void test_optimize_sb() {
        Script s = new ScriptBuilderWithVar().op(OP_TOALTSTACK).op(OP_FROMALTSTACK).optimize().build();
    ...
    public void test_optimize2_sb() {
        Script s = new ScriptBuilderWithVar().op(OP_TOALTSTACK).number(4).op(OP_FROMALTSTACK).optimize().build();
    ...
    public void test_optimize3_sb() {
        Script s = new ScriptBuilderWithVar().op(OP_TOALTSTACK).op(OP_FROMALTSTACK).number(4).op(OP_TOALTSTACK)
            .op(OP_FROMALTSTACK).optimize().build();
    ...
    public void test_optimize5_sb() {
        Script s = new ScriptBuilderWithVar().op(OP_TOALTSTACK).op(OP_TOALTSTACK).number(4).op(OP_FROMALTSTACK)
            .op(OP_FROMALTSTACK).optimize().build();
