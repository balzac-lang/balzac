...
public class TransactionBuilderTest {
    ...
    public void test() {
        ...
        tb.addVariable("anotherVeryLongName", String.class).bindVariable("anotherVeryLongName",
            "hihihhihihihihihiihihihi");

        tb.addInput(Input.of(InputScript.create().number(5)));
        tb.addInput(Input.of(InputScript.create().number(42)));
        tb.addOutput(OutputScript.createP2SH().number(3).addVariable("veryLongName", String.class)
            .addVariable("foo", String.class).bindVariable("foo", "pippo"), 34);
